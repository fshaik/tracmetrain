...
public	class TrainingModel {
	...
	private void getScaleParameters(){
		...
		try{
			FileInputStream fstream = new FileInputStream(trainFile + ".range");
	...
	private void getTrainingAccuracy() {
		try{
			FileInputStream fstream = new FileInputStream(trainFile + ".log");
			DataInputStream in = new DataInputStream(fstream);
			BufferedReader br = new BufferedReader(new InputStreamReader(in));
	...
	private void getModelParameters(){
		try{
			...
			FileInputStream fstream = new FileInputStream(trainFile + ".model");
			DataInputStream in = new DataInputStream(fstream);
			BufferedReader br = new BufferedReader(new InputStreamReader(in));
